...
<%-- 상단 공통페이지 영역을 외부 포함파일로 처리하는 jsp:include 액션태그이다.
	서브페이지에서 외부포함파일로 처리하면 중복코드를 안하게 해줘서 효율성이 좋아진다.
	이렇게 처리하는 부분은 서버 언어만 가능하다. --%>
...
<article id="sub_main_cont">
 <h1>Welcome</h1>
    <figure class="ceo"><img src="../images/company/CEO.jpg" width="196" height="226" alt="CEO" /><%-- figure는 html5에서 추가된 태드로 그림삽입해서 표현할 때
...
<%-- 하단 공통페이지 외부 포함파일로 처리, include 디렉티브. 
이 방법은 MS사에서 비주얼베이직 기반언어로 만든 서버 스크립트 언어인 ASP에서 사용하는 방식과 비슷하다.--%>
